...
\begin{abstract}
Electron spin resonance (ESR) and nuclear magnetic resonance (NMR) are two important spectroscopic techniques for studying properties of materials possessing a non-zero total magnetic moment.

In this experiment, we studied ESR on a sample of Diphenyl-Picryl-Hydrazil (DPPH), a paramagnetic substance with a single unpaired $e^-$, by measuring the resonant frequency as a function of an externally applied magnetic field, in order to determine the sample’s $g$-factor, which was found to be $g_{DPPH} = 2.02 \pm 0.01$.

We also investigated the magnetic properties of ${}^1$H and ${}^{19}$F nuclei in the following substances: glycerine and polystyrene, both containing hydrogen; PTFE, which contains fluorine; and polythene, whose composition we wanted to determine. The experimentally measured g-factors were $g_{Gly} = 5.54 \pm 0.03, g_{Poly} = 5.68 \pm 0.01 and g_{PTFE} = 5.34 \pm 0.01$. Comparison of these results with the ones obtained for polythene lead us to postulate the presence of hydrogen in our sample.
