...
Looking at table \ref{table: polythene}, and judging also from the general shape of the resonance signals observed on the oscilloscope, we concluded that polythene is likely to contain hydrogen, as its characteristics were similar to glycerine and polystyrene, and differed significantly from those~of~PTFE. 

This prediction agrees with polythene's chemical formula
...
\begin{center}
	...
	\vspace{5pt}
\end{center}
which shows that it does indeed contain H.

The accepted $g$-value for a proton is $g = 5.5856$, and for fluorine, $g = 5.2576$. Our glycerine value lies within $2\sigma$ of the proton value, but the other two results in table \ref{table: g-factors} differ by more than $5\sigma$ from the respective reference values. This might be due to a systematic error (e.g.\ in the calibration curve, although that would presumably affect the glycerine measurement just as well), or simply because, owing to the different chemical surroundings experienced by these nuclei in those substances, the $g$-factors actually differ from the quoted reference values.
...
\bibitem{Smith} Smith M and Strange J 1996 NMR techniques in materials physics: a review \textit{Meas. Sci. Technol.} \textbf{7} 449
\bibitem{Lancaster} Lancaster G 1967 Electron paramagnetic resonance (a review) \textit{J. Mat. Sci.} \textbf{2} 489-95
\bibitem{MacLaren} MacLaren I 2017 \textit{Electron spin resonance and nuclear magnetic resonance (Physics 3H Laboratory experiment information script)}, University of Glasgow
\bibitem{Gero} Gerothanassis I \textit{et al} K 2002 Nuclear magnetic resonance (NMR) spectroscopy \textit{Chem. Educ.} \textbf{3} 229-52
\bibitem{Haidekker} Haidekker M 2013 \textit{Medical Imaging Technology} ed Babaev E \textit{et al} (New York: Springer) pp 67-96
\bibitem{Ball} Ball D 2006 \textit{Field Guide to Spectroscopy} (SPIE) pp 83-6
\bibitem{Yadav} Yadav L 2005 \textit{Organic spectroscopy} (Springer) pp 224-49
\end{thebibliography}
